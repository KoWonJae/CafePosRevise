...
public class Pos implements ActionListener {
	...
	// orderList label 5개 -> 8개로 butoon으로
	JButton lorder0, lorder1, lorder2, lorder3, lorder4, lorder5, lorder6, lorder7;
	...
	public Pos() {
		...
		// 음료 메뉴
		String[] drinkMenu = { "Ice아메리카노", "Hot아메리카노", "Ice카페라떼", "Hot카페라떼", "Ice초코", "Hot초코", "Ice마끼아또", "Hot마끼아또", "Ice카푸치노", "Hot카푸치노", "딸기 스무디", "망고 스무디"};
		menuBtn = new RoundedButton[drinkMenu.length];

		// 메뉴버튼에 지정
		for (int i = 0; i < drinkMenu.length; i++) {
			menuBtn[i] = new RoundedButton(drinkMenu[i]);
			menuBtn[i].setFont(new Font("",Font.BOLD,15));
			menuBtn[i].setBackground(new Color(184, 134, 11) );
		}
		...
		addBtn = new JButton("+");
		addBtn.setFont(new Font("",Font.BOLD,40));
		subBtn = new JButton("ㅡ");
		subBtn.setFont(new Font("",Font.BOLD,40));
		...
		lorder5 = new JButton("");
		lorder5.setFont(new Font("", Font.BOLD, 20));
		lorder6 = new JButton("");
		lorder6.setFont(new Font("", Font.BOLD, 20));
		lorder7 = new JButton("");
		lorder7.setFont(new Font("", Font.BOLD, 20));
		lorder0.setBackground(new Color(204, 153, 051));
		lorder1.setBackground(new Color(204, 153, 051));
		lorder2.setBackground(new Color(204, 153, 051));
		lorder3.setBackground(new Color(204, 153, 051));
		lorder4.setBackground(new Color(204, 153, 051));
		lorder5.setBackground(new Color(204, 153, 051));
		lorder6.setBackground(new Color(204, 153, 051));
		lorder7.setBackground(new Color(204, 153, 051));



		olls = new JButton[] { lorder0, lorder1, lorder2, lorder3, lorder4, lorder5, lorder6, lorder7 };
		...
		lTotal1.setBorder(new EtchedBorder(EtchedBorder.RAISED));
		lTotal2 = new JLabel("");
		lTotal2.setFont(new Font("", Font.BOLD, 40));
		lMoney1 = new JLabel("  받은금액");
		lMoney1.setFont(new Font("", Font.BOLD, 40));
		lMoney1.setBorder(new EtchedBorder(EtchedBorder.RAISED));
		lMoney2 = new JLabel("");
		...
		lChange1.setBorder(new EtchedBorder(EtchedBorder.RAISED));
		lChange2 = new JLabel("");
	...
	void addLayout() {
		...
		pMenuList.setBackground(Color.BLACK);
		pMenuList.setLayout(new GridLayout(4, 2));
		...
		pCenter.add(lorder6);
		pCenter.add(lorder7);
		pCenter.setBackground(new Color(204, 153, 051));
		...
		pTotal.setLayout(new GridLayout(3, 2, 150 , 0));
		pTotal.add(lTotal1);
		pTotal.add(lTotal2);
		pTotal.add(lMoney1);
		pTotal.add(lMoney2);
		...
		pPayment.setLayout(new GridLayout(3, 2, 1, 1));
		pPayment.add(addBtn);
		pPayment.add(subBtn);
		pPayment.add(sumBtn);
...
//				}
//				
//				if (olls[i].getText().contains("Ice카푸치노")) {
//					cNum = i;
//					IceCapuchino p = new IceCapuchino("Ice카푸치노", 4000, 0);
//					IceCapuchino.count++;
//					olls[i].setText("  " + (i+1) + p.toString());
//				}
//				
//				if (olls[i].getText().contains("Hot카푸치노")) {
//					cNum = i;
//					HotCapuchino p = new HotCapuchino("Hot카푸치노", 4000, 0);
//					HotCapuchino.count++;
//					olls[i].setText("  " + (i+1) + p.toString());
//				}
//				
//				if (olls[i].getText().contains("딸기스무디")) {
//					cNum = i;
//					StrawberrySmoothie p = new StrawberrySmoothie("딸기스무디", 6000, 0);
//					StrawberrySmoothie.count++;
//					olls[i].setText("  " + (i+1) + p.toString());
//				}
			}
		}
		...
		if (ev == resetBtn) {
			...
			HotLatte.count = 0;
			HotMacchi.count = 0;
			IceCapuchino.count = 0;
			HotCapuchino.count = 0;
			StrawberrySmoothie.count = 0;
		}
